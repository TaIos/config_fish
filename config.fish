...
alias gxx='g++ -Wall -pedantic -Wextra --std=c++20 -o run.out'
alias pdp='g++ -Wall -pedantic -Wextra --std=c++20 -O3 -funroll-loops -o run.out'
alias pdpdeb='g++ -Wall -pedantic -Wextra --std=c++20 -O3 -funroll-loops -g -o run.out'
